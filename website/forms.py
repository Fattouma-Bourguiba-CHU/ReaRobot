...
class AddPatientForm(forms.ModelForm):
    ...
    num_cin = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"CIN Number", "class":"form-control"}), label="")
    email = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Email", "class":"form-control"}), label="")
    phone = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Phone", "class":"form-control"}), label="")
    birth_date = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Date Of Birth", "class":"form-control"}), label="")
    ...
    care_unity = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Care Unity", "class":"form-control"}), label="")
